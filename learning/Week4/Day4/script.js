...
function stateenable(selectedstate)
            {
                                   ...
                                   var state=[];
                                   state[1]=("AndraPradesh|ArunachalPradesh|Assam|Bihar|Chattisgarh|Goa|Gujrat|Haryana|HimachalPradesh|jharkhand|karnataka|MadhyaPradesh|manipur|Mizoram|Telengana|UttarPradesh|WestBengal");
